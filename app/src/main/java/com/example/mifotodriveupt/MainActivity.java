package com.example.mifotodriveupt;
...
public class MainActivity extends AppCompatActivity {
    ...
    static final String DISPLAY_MESSAGE_ACTION = "com.example.mifotodriveupt.DISPLAY_MESSAGE";
            ...
            public void run() {
                try {
                    ...
                    if (idCarpeta == null) {
                        ...
                        metadataFichero.setParents(Collections.singletonList("1gNfMp3xgucnL04p1UMtIqOXTiPyrsX36"));
